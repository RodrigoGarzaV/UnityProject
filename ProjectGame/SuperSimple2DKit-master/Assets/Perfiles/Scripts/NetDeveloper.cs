...
public class NetDeveloper : MonoBehaviour
{
   ...
   //private string  baseURL = "https://localhost:5001/api/preguntas/NetDeveloper?";
   private string  baseURL = "https://localhost:44380/api/preguntas/NetDeveloper?";
