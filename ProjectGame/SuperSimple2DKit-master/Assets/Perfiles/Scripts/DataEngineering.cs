...
public class DataEngineering : MonoBehaviour
{
    ...
    private string  baseURL = "https://localhost:5001/api/preguntas/DataEngineering?";
     //private string  baseURL = "https://localhost:44380/api/preguntas/DataEngineering?";
    void OnEnable()
    {
        Cursor.visible = true;
        Time.timeScale = 0f;
