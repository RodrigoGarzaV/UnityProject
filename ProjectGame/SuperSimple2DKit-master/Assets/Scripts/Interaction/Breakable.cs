...
public class Breakable : MonoBehaviour
{
    ...
    public void GetHurt(int hitPower)
    {
        ...
        {
            if (!requireDownAttack || (requireDownAttack && PlatformerPlayer.Instance.pounding))
            {
                if (PlatformerPlayer.Instance.pounding)
                {
                    PlatformerPlayer.Instance.PoundEffect();
                }
                ...
                StartCoroutine(PlatformerPlayer.Instance.FreezeFrameEffect());
